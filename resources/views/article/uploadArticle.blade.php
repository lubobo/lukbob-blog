...
@endsection
@section('content')
    <form class="form-group" action="{{route('postUploadArticle')}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="col-xs-1">
            ...
            <select class="form-control" name="status_id">
                <option value="{{$article->status_id}}">{{$article->status->name}}</option>
                <option>--更新分类--</option>
        ...
        <div class="col-xs-1">
            ...
            <select class="form-control" name="tag_id">
                <option value="{{$article->tag_id}}">{{$article->Tag->name}}</option>
                <option>--更新标签--</option>
                @foreach($tags as $tag)
        ...
        <div class="col-xs-12">
            ...
            <textarea class="ckeditor" name="content">{{$article->content}}</textarea>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="thumbnail">
                            <img src="{{$article->pic}}" width="100%">
                        </div>
                        <input type="file" name="file" id="file">
                        <p> </p>
                        <input type="hidden" class="form-control" name="pic" value="{{$article->pic}}">
                    </div>
